...
<html lang="zh-CN">
    ...
    <body>
        ...
        <%@include file="../include/top.jsp" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    <img src="../img/huanying.jpg" class="img-responsive center-block"/>
                    <h1>&nbsp</h1>
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            <form class="form-horizontal" action="/dinner/UserSer?action=userRegist" method="post">
